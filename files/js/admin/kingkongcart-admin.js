...
function add_second_option(option_id,option_name){
   ...
   jQuery(".option_"+option_id).after("<tr style='background:#f4e7e7; text-align:center' class='second_option_tr_"+option_id+"_"+numbering+"'><td>보조</td><td><input type='text' name='kkcart_second_option_"+option_id+"_"+numbering+"'></td><td><input type='text' name='kkcart_second_price_"+option_id+"_"+numbering+"'></td><td><input type='text' name='kkcart_second_amount_"+option_id+"_"+numbering+"'></td><td><select name='kkcart_second_option_status_"+option_id+"_"+numbering+"'><option value='2'>판매중</option><option value='1'>일시품절</option><option value='0'>품절</option></select></td><td><input type='button' class='button' value='삭제' onclick='remove_second_option("+option_id+","+numbering+");'></td></tr>");

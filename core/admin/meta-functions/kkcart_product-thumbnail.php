...
<?php
	...
	for ($i=0; $i < count($each_thumb_id); $i++) { 
		
		if( $i == (count($each_thumb_id) -1) ){
			$all_thumb_id .= $each_thumb_id[$i];
		}
		else {
			$all_thumb_id .= $each_thumb_id[$i].",";
		}
		...
		<li class="added_thumbnail_each">
			<ul>
				...
				<li class="kkcart-added-thumbnail-filename">
					...
					<div style="position:relative; top:10px; left:10px; color:gray">등록된 썸네일 입니다.</div>
				</li>
...
<?php
	if($discount_rate != ""){
?>
			<input type="text" style="width:36px" name="discount" value="<?echo $discount_rate;?>">%
<?php
	} else {
?>
			<input type="text" style="width:36px" name="discount" disabled="true" value="<?echo $discount_rate;?>">%
<?php
	}
?>
		...
		<li style="float:left; position:relative; top:15px; margin-right:30px;">
			<input type="text" name="discount_price" style="width:150px; text-align:right" value="<?echo $discount_price;?>">원
		</li>
...
<?php
	if($mileage_rate != ""){
?>
			<input type="text" name="mileage" style="width:36px" value="<?echo $mileage_rate;?>">%
<?php
	} else {
?>
			<input type="text" name="mileage" disabled="true" style="width:36px" value="<?echo $mileage_rate;?>">%
<?php
	}
?>
		...
		<li style="float:left;">
			<div style="position:relative; top:15px"><input type="text" name="mileage_price" style="width:150px; text-align:right;" value="<?echo $mileage_price;?>">원(점)</div>
		</li>
	</ul>
...
?>
	<ul>
		...
		<li style="float:left; margin-right:10px" onclick="input_complete_option();"><a class="button">추가/수정</a></li>
...
?>
					...
					<tr style="background:#e8e8e8; text-align:center" class="option_<?php echo $i;?>" id="input_first_option">
						<td>필수</td>
...
?>
                    ...
                    <tr style="background:#f4e7e7; text-align:center" class="second_option_tr_<?php echo $i;?>_<?php echo ($o+1);?>">
                        <td>보조</td>

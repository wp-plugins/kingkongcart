...
<?php
		...
		switch($payment_method){
			...
			$button = "<input type='submit' value='결제하기'>";
			break;
		}
				...
				<tr>
					...
					<td>
						<ul class="postcode_input_ul">
							...
							<li><input type="text" name="postcode1" class="kingkong_input_s" value="<?php echo $zipcode1;?>"> - <input type="text" name="postcode2" class="kingkong_input_s" value="<?php echo $zipcode2;?>"> <input type="button" value="우편번호 검색" onclick="showDaumPostcode();"></li>
...
?>
		...
		<div class="kingkongcart-mileage-use">
			<table>
				<tr>
					<th>사용할 적립금</th>
					<td><input type="text" name="input_mileage" value="<?php echo $_POST['using_mileage'];?>"> <input type="button" value="적립금 사용" onclick="use_mileage(<?php echo $user_id;?>);"> 
...
?>
		...
		<div class="kingkongcart-coupon-use">
			<table>
				<tr>
					<th>사용할 쿠폰 선택</th>
					<td><input type="text"> <input type="button" value="쿠폰선택"></td>
				</tr>
			</table>
		</div>
<?php 

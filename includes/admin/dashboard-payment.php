...
if(sanitize_text_field( $_POST['form_status'] )){
	...
	$payment = array();
	$payment['method'] 		= sanitize_text_field( $_POST['payment_method'] );
	$payment['yd_check'] 	= sanitize_text_field( $_POST['yd_check'] );
	$payment['site_code'] 	= sanitize_text_field( $_POST['site_code'] );
	$payment['site_key'] 	= sanitize_text_field( $_POST['site_key'] );
	$payment['paykind'] 	= sanitize_text_field( $_POST['paykind'] );

	...
	*/
	...
	$wpdb->insert( 
		...
		array( 
			...
			'address_doro'		=> "[".$kingkongcart_pay_zipcode."] ".$kingkongcart_pay_address_doro,
			'address_jibun'		=> "[".$kingkongcart_pay_zipcode."] ".$kingkongcart_pay_address_jibun,
	...
	$buyer_info = array(
		...
		'buyer_phone'	=> $kingkongcart_pay_receive_contact		 
	);
...
*/
	...
	$origin_user_info['zipcode'] 		= $kingkongcart_pay_zipcode;
	$origin_user_info['address_doro'] 	= $kingkongcart_pay_address_doro;
	$origin_user_info['address_jibun'] 	= $kingkongcart_pay_address_jibun;
	$origin_user_info['address_else'] 	= $kingkongcart_pay_address_detail;
	$origin_user_info['tel']			= $kingkongcart_pay_receive_contact;
	$origin_user_info['phone']			= $kingkongcart_pay_receive_contact;
...
/* wp_mail 관리자 전송 */
	...
	do_action("kingkong_order_complete", $user_id);
